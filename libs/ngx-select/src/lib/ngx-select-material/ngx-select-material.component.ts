import { Component, ElementRef, EventEmitter, forwardRef, Inject, Input, OnDestroy, Output, ViewEncapsulation } from '@angular/core';
...
export class NgxSelectMaterialComponent<T> extends NgxSelect<T> implements OnDestroy {
  ...
  @Input() override placeholder: string | undefined;

  @Output() override changeToggleState: EventEmitter<NgxSelectToggleState> = new EventEmitter<NgxSelectToggleState>();
